...
<script>
import commonTree from '@/components/blog/CommonTree.vue'
    ...
    menuComponent() {
      ...
      if (this.menu.path && this.menu.path !== '/') {
        ...
        if (isUrl) {
          ...
          comp = `前端组件：blog${this.menu.path}/Index.vue`
        }
      } else {
        comp = `前端组件：blog/Index.vue`
      }
      return comp
    }
  },
  ...
  methods: {
    ...
    computedComponent() {
      ...
      if (isUrl) {
        ...
        if (this.menu.path) {
          this.menu.component = `blog${this.menu.path}/Index`
        } else {
          this.menu.component = `blog/Index`
        }
      }
    },
    initMenuTree() {
