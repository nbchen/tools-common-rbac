  ...
  <div class="login-container">
    ...
    >
      <div class="title-container">
        ...
        <img src="@/assets/nbchen_blog.svg" alt="" style="width:255px;">
    ...
    <span class="login-footer">© 2022 - 蹒跚学步架构师</span>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    loginSuccessCallback(user) {
      ...
      return commonApi.dictionaryEnums().then(response => {
        const res = response.data
        if (res.isSuccess) {
...
.login-container {
  background: url(../../assets/peach-0001.jpg) 60% no-repeat;
