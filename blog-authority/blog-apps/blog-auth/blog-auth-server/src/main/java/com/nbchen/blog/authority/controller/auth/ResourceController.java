...
import com.nbchen.blog.authority.dto.auth.ResourceSaveDTO;
import com.nbchen.blog.authority.dto.auth.ResourceUpdateDTO;
...
public class ResourceController extends BaseController {
    ...
    public R<List> list() {
        ...
        List<String> resourceList = list.stream().map((Resource r) -> r.getMethod() + r.getUrl()).collect(Collectors.toList());
