package com.nbchen.blog.databases.datasource;
...
import com.nbchen.blog.core.base.id.IdGenerate;
import com.nbchen.blog.core.base.id.SnowflakeIdGenerate;
import com.nbchen.blog.databases.mybatis.typehandler.FullLikeTypeHandler;
import com.nbchen.blog.databases.mybatis.typehandler.LeftLikeTypeHandler;
import com.nbchen.blog.databases.mybatis.typehandler.RightLikeTypeHandler;
import com.nbchen.blog.databases.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
    ...
    public MetaObjectHandler getMyMetaObjectHandler(@Qualifier("snowflakeIdGenerate")
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "blog.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
